...
const photos = [
  'https://res.cloudinary.com/rss-collection/image/upload/v1662977903/calendar/413-4138963_unknown-person-unknown-person-png_va69je.jpg',
  'https://res.cloudinary.com/rss-collection/image/upload/v1662977903/calendar/413-4138963_unknown-person-unknown-person-png_va69je.jpg',
  'https://res.cloudinary.com/rss-collection/image/upload/v1662977903/calendar/413-4138963_unknown-person-unknown-person-png_va69je.jpg',
  'https://res.cloudinary.com/rss-collection/image/upload/v1662977903/calendar/413-4138963_unknown-person-unknown-person-png_va69je.jpg',
  'https://res.cloudinary.com/rss-collection/image/upload/v1662977903/calendar/413-4138963_unknown-person-unknown-person-png_va69je.jpg',
...
const knownByMovies = [
  ...
  { popularity: '3', id: 1240 },
  { popularity: '3', id: 1241 },
  { popularity: '3', id: 1242 },
  { popularity: '3', id: 1243 },
  { popularity: '3', id: 1244 },
] as KnownByComponentType[];
...
export const ActorProfile = () => {
  ...
  return (
    <>
      ...
      <Grid>
        <Typography className={classes.knownByTitle} variant="h4">
          KNOWN BY
        </Typography>
        <KnownByComponent knownByMovies={knownByMovies} />
      </Grid>
    </>
  );
};
